...
<form id="fomes2" name="fomes2" method="post" action="js/form/choose_db_website.php" class="Aform fomes" >
	<?php 
	if(is_file("../../../../source/config/dev.ini"))
	echo '<p class="typedbdev"><i class="fa fa-warning"></i> Your database is in "Development mode"</p>';
	else if(is_file("../../../../source/config/prod.ini"))
...
<select id="typ" name="typ">
			    ...
			    <option value="null">-- Database type --</option>
				  ...
				  <input type="text" id="pas" name="pas" placeholder="Password" >

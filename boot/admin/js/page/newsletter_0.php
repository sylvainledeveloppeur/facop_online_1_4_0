    ...
    <tr>
      ...
      <th scope="col">Date</th>
	   ...
	   <!--555555555-->
		   ...
		   WHERE actif_new=:pse " ) ;
           $nbr_pseudo->execute(array('pse'=>0));
	  ...
	  echo  '<div class="ok_form tex_center mar_top_40">Total: '.$chif_pse['nbr'].'</div>';
			...
			$bloc=$tams->query('SELECT * FROM _admin_newsletter WHERE actif_new=0 ORDER BY id_new DESC LIMIT 100 ');
      ...
      <td data-title="Date">'.$done['date_new'].'
		...
		<ul class="supedit">
			<li><a href="ddf" data-table="_admin_newsletter" data-champid="id_new" data-champ="actif_new" data-action="actif"  data-id="'.$done['id_new'].'" class="action"><i class="fa fa-check" title="activate product"></i></a></li>

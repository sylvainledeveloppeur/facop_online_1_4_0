  ...
  $allowed = array('png');
		...
		if(isset($_FILES['mg1']) && $_FILES['mg1']['error'] == 0 )
		{
			...
			if(in_array(strtolower($extension), $allowed))
			{
			   ...
			   {*/
				  @unlink('../../../../source/img/logo/'.$_POST['chemin']); 
				   
				if(move_uploaded_file($_FILES['mg1']['tmp_name'], '../../../../source/img/logo/'.$_POST['chemin'].'' ) )
				  {
			...
			{
			echo  '<div class="stop_form">Veuilez selectionner une image au format "image.png" (logo)</div>';

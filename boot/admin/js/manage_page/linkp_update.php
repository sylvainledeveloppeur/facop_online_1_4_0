...
$bloc= $tams->query(" SELECT * FROM pack_link  WHERE id_pf=".$_GET["id"]." "  );
...
<form name="TAform" action="js/manage_form/linkp_update_sql.php" method="post" id="TAform" class="fosli" style="background-color: #e1e7ea;width: 100%;">
  ...
  <input type="hidden" name="aimg2h" id="imag" value="'.$done['linkEN'].'">
	...
	<div  class="linkp retou" data-page="linkp_show" data-title="Lien(pack)" data-parametre="id=1&type=1" >RETOUR </div>

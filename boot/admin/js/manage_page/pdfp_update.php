...
$bloc= $tams->query(" SELECT * FROM pack_pdf  WHERE id_pf=".$_GET["id"]." "  );
...
<form name="TAform" action="js/manage_form/pdfp_update_sql.php" method="post" id="TAform" class="fosli" style="background-color: #e1e7ea;width: 100%;">
  ...
  <input type="hidden" name="aimg2h" id="imag" value="'.$done['linkEN'].'">
	...
	<div  class="linkp retou" data-page="pdfp_show" data-title="Les PDF(pack)" data-parametre="id=1&type=1" >RETOUR </div>

...
if($_POST['use']!="0")
	...
	//on enregistre la commande du client dans la base donne
							$req=$tams->prepare('INSERT INTO blog_reaction (id_deba_react,id_user_react,reaction_react,date_react) 
							   VALUES (?,?,?,NOW()) ');
				   ...
				   <script> window.setTimeout("location=(\'reload_'.$_POST['deba'].'_blog\');",3000) </script>';

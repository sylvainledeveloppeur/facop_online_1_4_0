...
if(isset($_FILES['aimg']) && $_FILES['aimg']['error'] == 0)
		{
			...
			if(in_array(strtolower($extension), $allowed))
			{
				  ...
				  $Gimg2=$_SESSION['ava']=="seller.png" ? $_SESSION['id'].time().'.jpg' : $_SESSION['ava'];//nom grande img
				 
				
				//@unlink('../../../../source/img/store/'.$Gimg2);
				  if(move_uploaded_file($_FILES['aimg']['tmp_name'], '../../img/avatar/seller/'.$Gimg2 ))
				  {	
                                    ...
                                    { 
                                       ...
                                       $_SESSION['vil']=$vil;
                                         ...
                                         echo '<div class="ok_form">Vos informations ont été mis à jour</div>';
                                             ...
                                             //$BClas->resetFo();
                                  $BClas->redirectPgT("index.php?b=seller.settings.seller_information",3000);

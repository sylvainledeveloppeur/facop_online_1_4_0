  ...
  <div id="head" class="wow head_shado">
    ...
    <div class="headfor bg_blanc"> 
           ...
           <div class="fenetre after userheadphon"> 
               ...
               <li  class="uhpmenu"><a href="#"><i class="ion-android-apps"></i> MENU </a>
                ...
                <li  class="uhpava"><a href="#" class="col1"><?php echo '<img src="source/img/avatar/user/'.$_SESSION['ava'].'" alt="Logo "></a>';?>
                    
                   <ul class="ulsoumeuser after">
                   <li><a href="index.php?b=user.profil.user"><i class="ion-person"></i> PROFIL</a></li>
                   <li><a href="index.php?b=user.settings.user_information"><i class="ion-android-settings"></i> PARAMETRES</a></li>
        ...
        <div class=" after">
          <div class="logofor flo_lef wid_30"><a href="index.php"><img src="source/img/logo/logo.png" alt="Logo Moguez" ></a> </div>
           ...
           <!-- <li><a href="index.php?b=user.vendre.user"><i class="ion-cash"></i>VENDEUR</a>
            ...
            <li><a href="index.php?b=user.profil.user" class="col1"><?php echo '<img src="source/img/avatar/user/'.$_SESSION['ava'].'" alt="Logo ">'.$_SESSION['namE'][0].'</a>';?></li>
            <li><a href="index.php?b=user.settings.user_information" class="">Parametre <i class="ion-android-settings"></i></a></li>

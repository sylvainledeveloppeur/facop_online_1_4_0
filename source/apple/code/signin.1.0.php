                                                    ...
                                                    if ($chif_pse['nbr']==0)
                                                      {
                                                        ...
                                                        $req=$tams->prepare('INSERT INTO user_bonus  (id_user_bnk, user_bnk, amount_bnk,	pendingsold_bnk, pending_bnk,	pendistatu_bnk,	pendidate_bnk,	phpdate_bnk,	sqldate_bnk) 
                                                          VALUES (?,?,?,?,?,?,?,?,NOW()) ');
                                                          $inser=$req->execute(array( $outil["id"], $outil["pseudo"], 0, 0, 0, 0, 0, $BClas->phpDate() ));
                                                        ...
                                                        $inser=$req->execute(array( $outil["id"], 0, "Offre", "FACOP vous à offert le livre 'Le paradigme du vrai homme'... Suite à votre inscription", 0, 0, $BClas->phpDate() ));

                                                        //isertion livre la paradigme du vrai homme Facop A0

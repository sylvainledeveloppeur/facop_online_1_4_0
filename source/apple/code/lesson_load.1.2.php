        ...
        while ($outil = $query->fetch()) 
            {
                  ...
                  $reqUni=$tams->prepare("SELECT * FROM video  WHERE id_les_vi=".$outil["id_les"]." AND titre='Introduction' AND actif_vi=1   " ) ;
                                       ...
                                       $reqUniData["youtube_FR"]=!empty($reqUniData["youtube_FR"])? $reqUniData["youtube_FR"]:"no_video.mp4";
                                       $reqUniData["youtube_EN"]=!empty($reqUniData["youtube_EN"])? $reqUniData["youtube_EN"]:"no_video.mp4";

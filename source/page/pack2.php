	   ...
	   <div class="facfor after col_2_to_1" >
		...
		<div class="flo_lef wid_70" >
		 <?php 
			...
			?>
			<div id='plyr-youtube' data-type="youtube" data-video-id="<?php echo !empty($_GET['yid']) ? $_GET['yid']: $done['youtube_FR']; ?>"></div>
					
					<!--<video id="plyr-video" poster="source/img/video/presentation.png" controls>
						  <source src="source/video/presentation.mp4" type="video/mp4">
						  <source src="source/video/presentation.webm" type="video/webm">
						  <!-- Captions are optional -->
						  <!--<track kind="captions" label="English captions" src="/path/to/video-caption.vtt" srclang="en" default>
					</video>-->
			
		     <h2 class="h1 mar_top_35"><?php echo $done['titre']; ?></h2>
										  ...
										  while($doneV=$blocV->fetch())
											{
											  ...
											  if($doneV['titre']=="Conclusion")
											  {
												 ...
												 $con='<li class="after elvid" data-read="'.$doneV['youtube_FR'].'">
												 <a href="'.$alink.'" >
												 <i class="ion-ios-videocam"></i> '.$doneV['titre'].' </a></li>'; 
												  continue;
											  }
											  
											  $alink=$allow==0 ? '#':'index.php?b=uno.pack&d='.$done['codeName'].'&yid='.$doneV['youtube_FR'];
											  
											  echo '<li class="after elvid" data-read="'.$doneV['youtube_FR'].'">
											  <a href="'.$alink.'" >
											  <i class="ion-ios-videocam"></i> '.$doneV['titre'].'</a></li>';

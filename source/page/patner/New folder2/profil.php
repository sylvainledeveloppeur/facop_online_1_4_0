  ...
  <div class="bac_ex the_bac ">
	<div class="fenetre">
	  <div class="baccuser head_shado mar_auto bg_blanc">
          ...
          <form name="userfo" id="userfo" class="Tfom_ after" method="post" action="index.php?b=user.settings.user_information">
        ...
        <div class="eta_form"></div>
              ...
              echo '
              <div class="profimg"><img src="source/img/avatar/'.$_SESSION['ava'].'" alt="Logo Moguez"></div>
          ...
          <div class="loginp"><input type="text" name="tel" value="'.$_SESSION['tel'].'" disabled ><i class="ion-ios-telephone"></i></div>
          <div class="loginp"><input type="text" name="vil" value="'.$_SESSION['vil'].'" disabled ><i class="ion-ios-location"></i></div>
          <div class="loginp"><input type="text" name="pay" value="Allemagne" disabled ><i class="ion-ios-world"></i></div>
          <div class="loginp"><input type="text" name="date" value="Incription: '.$_SESSION['date'].'" disabled ><i class="ion-wand"></i></div>

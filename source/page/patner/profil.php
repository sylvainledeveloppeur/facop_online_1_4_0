  ...
  <div class="bac_ex the_bac ">
	<div class="fenetre">
	  <div class="baccuser head_shado mar_auto bg_blanc">
          ...
          <form name="userfo" id="userfo" class="Tfom_ after" method="post" action="index.php?b=patner.settings.patner_information">
        ...
        <div class="eta_form"></div>
              ...
              echo '
              <div class="profimg"><img src="source/img/avatar/patner/'.$_SESSION['ava'].'" alt="Logo Moguez"></div>

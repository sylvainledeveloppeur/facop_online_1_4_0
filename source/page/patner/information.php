  <h2 class="s_resul">Modifier mes informations</h2>
            ...
            <form name="userfo" id="userfo" class="Tfom_1 after" method="post" action="source/js/patner_js/profil_upd.php">
          ...
          <span><em class="nosex ion-android-checkbox-outline-blank osf0"></em><em class="oksex ion-android-checkbox osf1"></em> Femme</span></div>';
                ...
                echo '
              <div class="profimg"><img id="cpimg" src="source/img/avatar/patner/'.$_SESSION['ava'].'" alt="Logo "><i class="ion-android-add"></i>

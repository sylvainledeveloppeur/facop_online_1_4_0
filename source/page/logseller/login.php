<div id="pg_login">
    ...
    <ul class="ulcomp after"><li><a href="index.php?b=loguser.login.loguser">Compte client</a></li> <li><a href="#" class="bg_1">Compte vendeur</a></li> <li><a href="index.php?b=logpatner.login.logpatner">Compte partenaire</a></li>   </ul>
    ...
    <li>
     ...
     <form name="logfo" id="logfo" class="Tfom_1  Q_cols_2_1col" method="post" action="source/js/logseller_js/login.php" >
...
<div class="loginp"><input type="email" name="mai" placeholder="Email" required><i class="ion-android-person"></i></div>
       ...
       <p class="logfog"> <span> <input type="checkbox"> Rester connecté</span><span><a href="index.php?b=logseller.forgot.logseller&o=1">Mot de passe oublié</a></span></p>
         
        <input type="submit" class="btnlog bg_1" value="Connexion">
         
        <p class="crelog">Nouveau? <a href="index.php?b=logseller.signup.logseller">Créer mon compte</a></p>
           ...
           if ($chif_pse['nbr']==1)
               {
                      ...
                      $reqe1 =$tams->exec("UPDATE seller SET val=1  WHERE mai='".$_GET['email']."'  ");
                  if($reqe1)
                  {   
                   echo '<script>

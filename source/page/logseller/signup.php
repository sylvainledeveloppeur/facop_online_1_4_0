<div id="pg_login">
 <ul class="ulcomp after"><li><a href="index.php?b=loguser.signup.loguser">Compte client</a></li> <li><a href="#" class="bg_1">Compte vendeur</a></li> <li><a href="index.php?b=logpatner.signup.logpatner">Compte partenaire</a></li>   </ul>
    ...
    <li>
     ...
     <form name="logfo" id="logfo" class="Tfom_1  Q_cols_2_1col" method="post" action="source/js/logseller_js/signup.php" >
       ...
       <p class="logfog"> <span class="okcgu"> <input name="cgu" type="checkbox"> J'accepte <a href="index.php?b=uno.cgu">les conditions d'utilisations</a></span></p>
        ...
        <p class="crelog">Déjà inscrit ? <a href="index.php?b=logseller.login.logseller">Connexion</a></p>

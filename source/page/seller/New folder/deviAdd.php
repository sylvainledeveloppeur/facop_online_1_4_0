...
if(!empty($_GET['sheet']) AND $_GET['sheet']!='hi' OR empty($_GET['sheet']))
  ...
  ?>
	...
	<h1 class="hh11 tex_center">AJOUTER UN DEVI</h1>
	<!--us-->
...
<option value="Suivi de la realisation des projets immobiliers" >Suivi de la realisation des projets immobiliers</option>
...
<option value="Equipement des maison" >Equipement des maison</option>

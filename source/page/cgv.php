...
<div class="bac_top">
  <div class="fenetre">
	   ...
	   <div class="wid_90 mar_auto pagh1 tex_center" >
		     ...
		     <h1 class="h1"><?php if(array_key_exists($_GET['sheet'],$title_array))
...
<div class="fenetre">
		<div class="bg_blanc bord_1 pad_top_20 pad_bot_20 opag">
            
		    <div class="bleu_5 opag2 wid_80 mar_auto Qhelp">
	  
<p><strong>En vigueur au 16/08/2024</strong><br>
    Entre la Société Facocom Sarl,<br>

Yaoundé-Elig Essono,<br>

<!--au Capital Social de 1000000
immatriculée au Registre du Commerce et des Sociétés de PARIS,
sous le numéro SIRET-->
représentée par <br>

 en qualité de gérant, dûment habilité aux fins des présentes.
La société peut être jointe par email en cliquant sur le formulaire de contact accessible via la page d’accueil du site. Ou directement en utilisant l’adresse info@facop.training
...
Ci-après le « Vendeur » ou la « Société ». D’une part, Et la personne physique ou morale procédant à l’achat de produits ou services de la société, Ci-après, « l’Acheteur », ou « le Client » D’autre part, Il a été exposé et convenu ce qui suit :</p>
 ...
 <div class="line_policy">
        <div class="po_title">PREAMBULE</div>
        <div class="po_tex">

Le Vendeur est éditeur de Produits et Services de  <br>
- Formation en entrepreneuriat ;<br>
- Formation en leadership;<br><br>
à destination de consommateurs, commercialisés par l’intermédiaire de ses sites Internet (www.facop.training). La liste et le descriptif des biens et services proposés par la Société peuvent être consultés sur les sites susmentionnés. </div>
    </div><!--end line-->

 <div class="line_policy">
        <div class="po_title">Article 1 : Objet</div>
        <div class="po_tex">

Les présentes Conditions Générales de Vente déterminent les droits et obligations des parties dans le cadre de la vente en ligne de Produits ou Services proposés par le Vendeur. </div>
    </div><!--end line-->
 

 <div class="line_policy">
        <div class="po_title">Article 2 : Dispositions générales</div>
        <div class="po_tex">

Les présentes Conditions Générales de Vente (CGV) régissent les ventes de Produits ou de Services, effectuées au travers des sites Internet de la Société, et sont partie intégrante du Contrat entre l’Acheteur et le Vendeur. Elle sont pleinement opposable à l’Acheteur qui les a accepté avant de passer commande. Le Vendeur se réserve la possibilité de modifier les présentes, à tout moment par la publication d’une nouvelle version sur son site Internet. Les CGV applicables alors sont celles étant en vigueur à la date du paiement (ou du premier paiement en cas de paiements multiples) de la commande. Ces CGV sont consultables sur le site Internet de la Société à l’adresse suivante : www.facop.training.
...
Conformément aux dispositions légales en matière de conformité et de vices cachés <!--(art. 1641 c. civ.)-->, le Vendeur rembourse ou échange les produits défectueux ou ne correspondant pas à la commande. Le remboursement peut être demandé de la manière suivante : dépôt d’une plainte à l’adresse info@facop.training </div>
    </div><!--end line-->

 <div class="line_policy">
        <div class="po_title">Article 7 : Clause de réserve de propriété</div>
        <div class="po_tex">

Les produits demeurent la propriété de la Société jusqu’au complet paiement du prix. </div>
    </div><!--end line-->

 <div class="line_policy">
        <div class="po_title">Article 8 : Modalités de livraison</div>
        <div class="po_tex">

Les produits sont livrés à l’adresse de livraison qui a été indiquée lors de la commande et dans les délais indiqués. Ces délais ne prenent pas en compte le délai de préparation de la commande. Lorsque le Client commande plusieurs produits en même temps ceux-ci peuvent avoir des délais de livraison différents acheminés selon les modalités suivantes : livraison via un ou plusieurs colis. En cas de retard d’expédition dépôt d’une plainte à l’adresse info@facop.training. En cas de retard de livraison, le Client dispose de la possibilité de résoudre le contrat dans les conditions et modalités définies <!--à l’Article L 138-2 du Code de la consommation-->. Le Vendeur procède alors au remboursement du produit et aux frais « aller » <!--dans les conditions de l’Article L 138-3 du Code de la consommation-->. Le Vendeur met à disposition un point de contact téléphonique (coût d’une communication locale à partir d’un poste fixe) indiqué dans l’email de confirmation de commande afin d’assurer le suivi de la commande. Le Vendeur rappelle qu’au moment où le Client pend possession physiquement des produits, les risques de perte ou d’endommagement des produits lui sont transférés. Il appartient au Client de notifier au transporteur toute réserves sur le produit livré. </div>
    </div><!--end line-->

 <div class="line_policy">
        <div class="po_title">Article 9 : Disponibilité et présentation</div>
        <div class="po_tex">
...
A<!--rticle L. 217-5 du Code de la consommation : -->Le bien est conforme au contrat : 1° S’il est propre à l’usage habituellement attendu d’un bien semblable et, le cas échéant : – s’il correspond à la description donnée par le vendeur et possède les qualités que celui-ci a présentées à l’acheteur sous forme d’échantillon ou de modèle ; – s’il présente les qualités qu’un acheteur peut légitimement attendre eu égard aux déclarations publiques faites par le vendeur, par le producteur ou par son représentant, notamment dans la publicité ou l’étiquetage ; 2° Ou s’il présente les caractéristiques définies d’un commun accord par les parties ou est propre à tout usage spécial recherché par l’acheteur, porté à la connaissance du vendeur et que ce dernier a accepté.

...
if(!empty($_GET['o']) AND $_GET['o']==1 )
  ...
  ?>
    <li>
     ...
     <form name="logfo" id="logfo" class="Tfom_1  Q_cols_2_1col" method="post" action="source/js/logpatner_js/pass_forgot.php" >
...
<div class="loginp"><input type="email" name="mai" placeholder="Votre email" required><i class="ion-email"></i></div>
        ...
        <input type="submit" class="btnlog bg_1" value="Valider">
              ...
              <p class="crelog">Retour à la <a href="index.php?b=logpatner.login.logpatner">Connexion</a></p>
  ...
  ?> 
     ...
     <form name="logfo" id="logfo" class="Tfom_1  Q_cols_2_1col" method="post" action="source/js/logpatner_js/pass_reset.php" >
        <div class="eta_form"></div>
...
<div class="loginp hide"><input type="hidden" name="m" value="<?php echo $_GET['m'];?>" required><i class="ion-android-unlock"></i></div>
        ...
        <input type="submit" class="btnlog bg_1" value="Valider">
            ...
            <p class="crelog"><a href="index.php?b=logpatner.login.logpatner">Connexion</a></p>   
